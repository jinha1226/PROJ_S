...
func validation_error()->String:
	...
	if use_kind not in ["NONE","HEALING","ENERGY","EAT"]:return "unknown_item_use_kind"
	...
	if use_kind in ["HEALING","ENERGY","EAT"] and category!="CONSUMABLE":return "invalid_item_use_kind"
	return ""
