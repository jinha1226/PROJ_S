...
전투는 턴제 자동전투를 기본으로 합니다. 캐릭터의 태세·규칙·파츠가 행동을 고르고, 적이 시야에 들어오면 자동탐험이 멈춥니다. HUD에서 전투 시작/정지, 속도, 후퇴 명령, 대기, 자동탐험, 야영, 가방을 조작할 수 있습니다. 동료 AI와 3인 파티의 전투 코드는 테스트와 이후 NPC 영입 구현을 위해 유지됩니다. 현재 기본 Run에는 NPC가 배치되지 않습니다. [태세 설계](docs/superpowers/specs/2026-09-23-stances-design.md) · [효용 선택기](docs/superpowers/specs/2026-09-24-utility-lookahead-design.md).
