...
func run() -> void:
	...
	# The sword kit now uses the species' strength directly, without a mastery rank.
	check(base.damage == 12 and base.delay == 120 and base.ac == 1 and base.ev == 4,"starting equipment uses the essence stat sheet")
