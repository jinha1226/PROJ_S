...
- 그라데이션 없는 평면 채색. 도형마다 오른쪽에 평면 그림자 한 조각까지만.
- 인물은 콩 모양 몸통에 둥근 머리, 점 두 개의 눈. 무기와 소품은 몸에 비해 크게.
...
| 파일 | 내용 |
| --- | --- |
| `assets/flat-cartoon-v1/svg/*.svg` | 원본 벡터: 주인공, 고블린, 해골, 쥐, 오크, 상자, 통, 횃불, 물약, 두루마리, 아이콘 7종, 방 배경 |
