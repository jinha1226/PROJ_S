...
2026-09-23: 기존 먹선 원본 parts.png로 복원했다. 인간 전체 표시 배율은 2.0→2.4로 20% 확대하고, 머리는 최초 92×139에서 128.8×194.6으로 40% 확대했다. 머리 중심 x=128, 하단 y=163을 유지한다. 두 배율은 곱해 적용된다. 인게임 배치·docs/art/catalog.json·HTML 미리보기도 동기화했다.
...
- 보드와 이동 잔상은 하단을 고정하고 위로 확대한다. 레이어 인간은 기존 표시 영역의 2.4배, 여백이 적은 기존 동료는 1.67배로 표시한다. 타일 점유와 판정은 유지한다.
