...
영혼석은 탱커·근딜·원딜·마법·지원의 역할군 5개와 효과별 세부 유형 17개를 사용한다. 수치 보너스는 가장 높은 역할군 조합 2·4·6에서만 적용한다. 몬스터 수치용 기존 역할은 유지한다. 도감은 영혼석·아이템·빌드 3탭이며, 예시 빌드 11개와 3인 파티 4개를 기록 없는 아레나에서 시험할 수 있다. 원정 도감에서 시험에 들어가도 원정 세션은 보관·복원한다.
